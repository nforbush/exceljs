...
class VmlShapeXform extends BaseXform {
  ...
  parseClose(name) {
    ...
    switch (name) {
      case this.tag:
        this.model.objectType = this.map['x:ClientData'].model.objectType;  // *** ADD ***
        ...
        // *** ADD ***
        if (this.map['x:ClientData'].model && this.map['x:ClientData'].model.formulaTextbox)
          this.model.formulaTextbox = this.map['x:ClientData'].model.formulaTextbox;
        if (this.map['x:ClientData'].model && this.map['x:ClientData'].model.formulaLink)
          this.model.formulaLink = this.map['x:ClientData'].model.formulaLink;
        // *** ADD END ***
        return false;
      default:
        return true;
